		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					<h3>PaymentMethod</h3>
					<a href="<%=request.getContextPath()%>/admin/paymentMethod/new"
				...
				<div class="tab-content">
					...
					<s:form action="delete" id="form1">
						<table>
							...
							<tbody>
								<s:iterator value="paymentMethods" begin="%{startIndex}"
									end="%{endIndex}">
									<tr>
										<td><input type="checkbox" name="slelect"
											value=<s:property value = "id"/>></td>
										<td><s:property value="id" /></td>
										<td><s:property value="methodDescription" /></td>
										<td>
											<!-- Icons --> <a
											href="<%=request.getContextPath()%>/admin/paymentMethod/edit?id=<s:property value="id" />"
											title="Edit"><img
												src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a
											href="<%=request.getContextPath()%>/admin/paymentMethod/delete?id=<s:property value="id" />"
											title="Delete"><img
