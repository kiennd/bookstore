...
<<<<<<< HEAD
		...
		<div class="slider1">
			<s:iterator value="bestSellingBooks">
				<div class="slide">
					<a href="<%=request.getContextPath()%>/detailBook?id=${id}"><img
						src="images/books/${imageurl}" alt="" class="pro-img" /></a> <span
						class="title" style="height: 50px;"><a
						href="<%=request.getContextPath()%>/detailBook?id=${id}"><s:property
								value="title" /></a></span> <span class="rating-bar"><img
		...
		<div class="slider1" style="height: 700px;">
			<s:iterator value="newBooks">
				<div class="slide">
					<a href="<%=request.getContextPath()%>/detailBook?id=${id}"><img
						src="images/books/${imageurl}" alt="" class="pro-img" height="300"
						width="200" /></a> <span class="title" style="height: 50px;"><a
						href="<%=request.getContextPath()%>/detailBook?id=${id}"><s:property
								value="title" /></a></span> <span class="rating-bar"><img
						src="images/rating-star.png" alt="Rating Star" /></span>
					<div class="cart-price">
...
<<<<<<< HEAD
						...
						<div class="cart-price">
							<a href="<%=request.getContextPath()%>/addtocart.jsp?id=${id}"
								class="cart-btn2">Add to Cart</a> <span class="price">Gía:
								${price}</span>
						</div>
					</div>
					<div class="c-b-img">
